    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/admin/**").hasAnyAuthority("ADMIN") // Only admin can access
                        .requestMatchers("/teacher/**").hasAnyAuthority("TEACHER") // Only teacher can access
                        .requestMatchers("/student/**").hasAnyAuthority("STUDENT") // Only student can access
